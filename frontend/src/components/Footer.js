        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-3">
            ...
            <div className="d-flex footer-icons">
              <a href="https://facebook.com/yourpage" className="text-light me-3"><FontAwesomeIcon icon={faFacebook} size="2x" /></a>
              ...
              <a href="https://instagram.com/yourpage" className="text-light"><FontAwesomeIcon icon={faInstagram} size="2x" /></a>
            </div>
          </div>
        </div>
